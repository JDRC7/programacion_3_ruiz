...
for (let i = 0; i <= 5; i++) { //indice, condicon, comom va a incrementarse el indece
    console.log(i);
}

const frutas=["pera","manazana","naranja"]
for (let i = 0; i < frutas.length; i++) { //dice q frutas.length es 3, entonces el indice va a ser 0,1,2 y cuando sea 3 se sale porq debe ser menor a el numero de frutas
...
const productos = [
  ...
  { nombre: "Firewall",  stock: 0  }, // ← primero con stock crítico
  { nombre: "Access Point", stock: 4 },
];
