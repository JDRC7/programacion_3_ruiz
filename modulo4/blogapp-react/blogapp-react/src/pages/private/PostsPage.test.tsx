  ...
  return {
    Select: ({ children, onValueChange, value, defaultValue }: any) => (
      <SelectContext.Provider value={onValueChange}>
        <div data-testid="category-select" data-value={value || defaultValue || ''}>
          {children}
        </div>
...
it('should list, create, edit and delete a post end to end', async () => {
  ...
  // Seleccionar categoría con el mock del Select
  await user.click(screen.getByTestId(`option-${CATEGORY.id}`))
